export const LangBa = {
  ...
  ARTICLE_ON_USER: {
    ...
    TOOLTIP_MSG_SERIALNUMBER:
      "Serijski broj dodjeljen prilikom prvog zaduživanja opreme, te je u ovom koraku nemoguće promjeniti ga.",
    FORM_LABEL_INV_NUMBER: "Inventurni broj",
    TOOLTIP_MSG_INV_NUMBER:
      "Inventurni broj dodjeljen prilikom prvog zaduživanja opreme, te je u ovom koraku nemoguće promjeniti ga.",
